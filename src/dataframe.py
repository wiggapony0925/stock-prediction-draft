...
def display_stock_data(selected_stock, selected_start_date, selected_end_date):
    ...
    view_option = st.selectbox("Select View", ["Dataframe", "Line Chart", "Area Chart"])
    ...
    if view_option == "Dataframe":
        st.dataframe(stock_data)
    elif view_option == "Line Chart":
        st.line_chart(stock_data["Close"], use_container_width=True)
    elif view_option == "Area Chart":
        st.area_chart(stock_data["Close"], use_container_width=True)
